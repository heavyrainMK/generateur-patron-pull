class Front:
    ...
    def setLeftStitches(self, increase):
        self.left_front_stitches = self.left_front_stitches + increase

    def getLeftFrontStitches(self):
        return left_front_stitches

    def setRightFrontStitches(self, increase):
        self.rigth_front_stitches = self.rigth_front_stitches + increase

    def getRightFrontStitches(self):
        return self.rigth_front_stitches
