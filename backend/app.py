...
def calculer_patron():
    ...
    tour_taille = float(data['tour_taille']) if 'tour_taille' in data and data['tour_taille'] else None
    hauteur_nuque_taille = float(data['hauteur_nuque_taille']) if 'hauteur_nuque_taille' in data and data['hauteur_nuque_taille'] else None
    tour_hanches = float(data['tour_hanches']) if 'tour_hanches' in data and data['tour_hanches'] else None
